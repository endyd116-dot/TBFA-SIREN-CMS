...
>
> **마지막 갱신**: 2026-05-21 / **성과관리 화면 통합 종결 + 급여 고도화 Stage3 머지(검증 대기) + 근태 연동 갭 수정 C 트리거 발행**
...
### 진행 중 트랙 (2026-05-21)
- **급여 고도화 Stage3** — 머지(`a30c23f`) 완료·Swain 라이브 검증 대기. 설계: `docs/active/2026-05-20-payroll-enhance.md`.
- **근태 연동 갭 수정(G1·G2·G3·G4)** — 설계·C 트리거 발행(`610e64e`). C가 worktree에서 수정 → push 후 메인 머지·검증. 설계: `docs/active/2026-05-20-att-gap-fix.md`.
- ✅ **성과관리 화면 통합** — 종결(§7.6).
