...
>
> **마지막 갱신**: 2026-07-20 / **🧾 지출결재·지출결의서 트랙** (그 이전 = 💰 급여 고도화 + 🕐 KST 전면 정비).
> **▶ 최신 세션 인수인계 = 아래 §0-A(지출결재 트랙·2026-07-16~20) + [`docs/active/2026-07-13-session-handoff.md`](../active/2026-07-13-session-handoff.md)(급여·KST) — 새 메인은 이 둘부터 정독.**
