...
```javascript
const MOCK_STORIES = [
  { id:1, youtubeId:"dQw4w9WgXcQ", title:"[1분 인터뷰] 유가족의 목소리 — 함께 들어주세요",
    subtitle:"짧지만 깊은, 남겨진 이들의 한마디", thumbnailUrl:"https://i.ytimg.com/vi/dQw4w9WgXcQ/hqdefault.jpg",
    summary:"1분 남짓한 시간에 담긴 유가족의 진심. 가장 먼저 들어주세요.", duration:"1:22", category:"voice" },
  { id:2, youtubeId:"dQw4w9WgXcQ", title:"서이초 사건 그 이후… 교사유가족협의회란?",
    subtitle:"왜 우리가 모였는가", thumbnailUrl:"https://i.ytimg.com/vi/dQw4w9WgXcQ/hqdefault.jpg",
    summary:"한 선생님의 죽음 이후, 유가족이 직접 만든 협의회의 시작과 약속.", duration:"5:38", category:"intro" },
  { id:3, youtubeId:"dQw4w9WgXcQ", title:"[유가족의 목소리] 교육공동체 헌정 영상",
    subtitle:"기억을 모아 만든 헌정", thumbnailUrl:"https://i.ytimg.com/vi/dQw4w9WgXcQ/hqdefault.jpg",
    summary:"먼저 떠난 선생님들과 교육공동체에 바치는 짧은 헌정 영상.", duration:"2:34", category:"tribute" },
  { id:4, youtubeId:"dQw4w9WgXcQ", title:"[유가족의 목소리] 교사 유가족의 인터뷰",
    subtitle:"긴 호흡으로 듣는 이야기", thumbnailUrl:"https://i.ytimg.com/vi/dQw4w9WgXcQ/hqdefault.jpg",
    summary:"16분, 유가족이 직접 들려주는 그날 이후의 삶과 바람.", duration:"16:51", category:"interview" },
];
```

### §5.2 시드 detailHtml (메인 작성 — 마이그 INSERT용·status='draft')

> youtubeId/Url은 Swain이 4개 영상 URL 제공 시 채움(미제공이면 null로 draft 시드 → 어드민에서 URL 연결·발행).
