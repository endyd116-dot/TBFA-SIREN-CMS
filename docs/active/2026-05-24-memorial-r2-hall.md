...
> 영정 사진(photo_blob_id) null → 실루엣. 어드민에서 업로드·실명·세부 보완. 모두 `is_public=true`(Swain 검수 후 발행 권장 — 필요 시 false로 시드).
> ⚠️ 확인 필요: 대전 학교명(보도상 관평초·용산초 / Swain "학산초")·일부 정확 일자·실명 공개 범위.
...
| 7 | 故 대전 선생님 | 대전(관평초·용산초·※확인) | 2023-09-07 | — |
