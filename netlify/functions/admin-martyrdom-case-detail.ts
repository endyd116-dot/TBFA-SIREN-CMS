  ...
  try {
    ...
    try {
      const r: any = await db.execute(sql.raw(`
        SELECT
          ...
          mc.consent_note AS "consentNote",
          mc.consent_obtained_at AS "consentObtainedAt",
    ...
    return jsonOk({
      case: {
        ...
        consentNote: caseRow.consentNote ? String(caseRow.consentNote) : null,
        consentObtainedAt: caseRow.consentObtainedAt ? new Date(caseRow.consentObtainedAt).toISOString() : null,
