...
> - ⏳ C 진행 중: 메뉴얼 2종 + AI 학습자료(jsonl 311문항·knowledge.md) 신규기능 동기화 + 업체명 정정(토스→KICC·알리고→솔라피). 단일 출처 `docs/active/2026-05-25-manual-spec-sync.md`.
> - 🔴 미push: 위 작업 commit 누적 → C 메뉴얼/AI 완료 후 전체 묶어 **1회 push**.
