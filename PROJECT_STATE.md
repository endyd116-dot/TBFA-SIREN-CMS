...
| 시각 | 갱신자 | 내용 |
|---|---|---|
| 2026-05-11 | 메인 | **Phase 10 R2 설계서 작성 완료 (수신자 그룹 선택)** — DB(recipient_groups 1테이블 + 시드 5종) / API 8개(헬퍼 lib/recipient-resolve.ts + filter·manual 분기) / 화면 2개(필터 빌더·수동 명단·미리보기 모달) / 검증 시나리오 Q1~Q9 + 성능 점검 / 4채팅 프롬프트 / 평행 모드 / B·A 트리거 대기 |
