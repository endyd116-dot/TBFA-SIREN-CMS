...
| 시각 | 갱신자 | 내용 |
|---|---|---|
| 2026-05-19 | **메인** | **✅ 라운드10 C 검증 완료 12/12 PASS** (main @ 4a1d5ca) — 댓글투표/신고·파일공유·알림설정·AI배정·회귀 전부 PASS. 워크스페이스 버그 4건 fix 푸시 완료. C 버그픽스 검증 대기 중 |
...
🔍 워크스페이스 버그 4건 fix — C 검증 대기 중
   - 근태관리 인증 오류·리다이렉트 fix
   - 성과 관리 무한 로딩 fix
   - 파일함 SPA 전환 fix
   - 모바일 허브 버튼 노출 fix
