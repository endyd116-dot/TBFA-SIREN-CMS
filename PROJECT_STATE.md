...
| 2026-05-10 | 메인 | **Phase 10~22 카탈로그 합의 완료** — 13개 후보 → 9개 작업 통합 / Phase 10~20 분배 / Phase 21~22 여유 슬롯 / [카탈로그](docs/milestones/2026-05-10-phase10-22-catalog.md) |
...
```
🟢 Phase 8 라운드 진행 중 (2026-05-10)
   ├─ A: ✅ 디스패처 머지 완료 (5fd603a) + 운영 DB 마이그 OK / 마이그 파일 cleanup push 대기
   ├─ B: 🟢 7개 미구현 자리 통합 즉시 착수 (디스패처 import 1줄 + dispatch 호출 패턴)
   ├─ C: 🟢 Q12 fix 진행 / B 머지 후 어드민 발송 로그 화면 시작
   └─ D: 휴면
   메인: A cleanup 흡수 / B 머지 보고 / C Q12 fix 보고 대기
```
...
| `../tbfa-mis-B` | `feature/phase8-notify-integration` | 🟢 7개 미구현 자리 통합 즉시 착수 |
