...
| 시각 | 갱신자 | 내용 |
|---|---|---|
| 2026-05-19 | **메인** | **🚀 Phase 25 WBS↔마일스톤 유기적 연동 구현 완료** (main push 중) — 마이그 파일·AI 백그라운드·API 5개·admin-workspace-tasks 수정·workspace.html 게이지·milestones.js/kanban.js 수정. **마이그레이션 호출 필요**: `https://tbfa.co.kr/api/migrate-phase25-milestone-tasks?run=1` |
