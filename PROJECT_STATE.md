...
| 시각 | 갱신자 | 내용 |
|---|---|---|
| 2026-05-09 | 메인 채팅 | A 검증 중 #BUG-1 발견 (lib/auth.ts:128 user.id 버그) → 오류 리포트 작성 + 검증 보류, 추후 처리 |
...
| ID | 발견 | 위치 | 심각도 | 상태 | 리포트 |
|---|---|---|---|---|---|
| **#BUG-1** | 2026-05-09 | `lib/auth.ts:128` | 🔴 Critical | 미해결 (수정 보류) | [docs/issues/2026-05-09-requireActiveUser-uid-bug.md](docs/issues/2026-05-09-requireActiveUser-uid-bug.md) |
