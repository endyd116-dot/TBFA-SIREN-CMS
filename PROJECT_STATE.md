...
| ID | 발견 | 위치 | 심각도 | 상태 | 리포트 |
|---|---|---|---|---|---|
| #BACKFILL-1 | 2026-05-10 | 효성 후원 7건 결제일 NULL | 🟡 Medium | 🟡 마이그 main 머지 완료 — Swain `/api/migrate-hyosung-paid-date-backfill?run=1` 호출 대기 | [docs/issues/2026-05-10-hyosung-paid-date-backfill.md](docs/issues/2026-05-10-hyosung-paid-date-backfill.md) |
